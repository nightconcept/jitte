	...
	>
		...
		>
			...
			<div class="px-6 py-4 max-h-[60vh] overflow-y-auto">
				<!-- Error Message -->
				<div class="mb-4">
					<h3 class="text-sm font-semibold text-[var(--color-text-primary)] mb-2">Error Message:</h3>
					<div class="p-3 bg-[var(--color-bg-primary)] rounded border border-[var(--color-border)] text-red-400">
						{message}
					</div>
				</div>
				...
				<div>
					...
					<div class="p-3 bg-[var(--color-bg-primary)] rounded border border-[var(--color-border)] text-[var(--color-text-secondary)] font-mono text-xs whitespace-pre-wrap break-all">
						{details}
					</div>
				</div>
			</div>
