...
<nav
  class="bg-[var(--color-bg-secondary)] border-b border-[var(--color-border)] px-6 py-3 sticky top-0 z-50"
>
  <div class="flex items-center justify-between">
    ...
    <div class="flex items-center gap-3">
      ...
      <div class="flex items-center gap-2">
        <div
          class="w-[38px] h-[38px] rounded flex items-center justify-center font-bold text-white"
          style="background: linear-gradient(to bottom right, var(--color-brand-primary), var(--color-accent-purple));"
        >
      ...
      {#if hasDeck}
        ...
        <button
          ...
          title="Import Deck from Decklist"
        >
          <svg
            class="w-4 h-4"
            fill="none"
          ...
          {#if exportDropdownOpen}
            ...
            >
              ...
              >
                ...
                >
                  <path
                    d="M277,546l-43,25l-43-25v-50l43-25l43,25V546z"
                    fill="currentColor"
                    transform="matrix(-4.8999924659729, 0.008858803659677505, -0.008858803659677505, -4.8999924659729, 1846.5793449325784, 3187.4970451598238)"
                  />
                  <path
                    d="M277,546l-43,25l-43-25v-50l43-25l43,25V546z"
                    fill="#333333"
                    transform="matrix(-4.182153701782227, 0.007560909725725653, -0.007560909725725653, -4.182153701782227, 1677.7490226669538, 2814.728490472323)"
                  />
                  <path
                    d="M277,546l-43,25l-43-25v-50l43-25l43,25V546z"
                    fill="currentColor"
                    transform="matrix(-4.8999924659729, 0.008858803659677505, -0.008858803659677505, -4.8999924659729, 1635.6136466903913, 2824.5324455504488)"
                  />
                  <path
                    d="M277,546l-43,25l-43-25v-50l43-25l43,25V546z"
                    fill="#FF9C00"
                    transform="matrix(-4.182153701782227, 0.007560910191386938, -0.007560910191386938, -4.182153701782227, 1466.783203125, 2451.7641601562505)"
                  />
                  <path
                    d="M277,546l-43,25l-43-25v-50l43-25l43,25V546z"
                    fill="currentColor"
                    transform="matrix(-4.8999924659729, 0.008858803659677505, -0.008858803659677505, -4.8999924659729, 1427.6663810653913, 3188.1803947691988)"
                  />
                  <path
                    d="M277,546l-43,25l-43-25v-50l43-25l43,25V546z"
                    fill="#CBCBCB"
                    transform="matrix(-4.182153701782227, 0.007560909725725653, -0.007560909725725653, -4.182153701782227, 1258.8360587997663, 2815.412572503573)"
                  />
                  <path
                    d="M277,546l-43,25l-43-25v-50l43-25l43,25V546z"
                    fill="currentColor"
                    transform="matrix(-4.8999924659729, 0.008858803659677505, -0.008858803659677505, -4.8999924659729, 1634.0981437607038, 3067.1901603941988)"
                  />
                  <path
                    d="M277,546l-43,25l-43-25v-50l43-25l43,25V546z"
                    fill="#333333"
                    transform="matrix(-4.182153701782227, 0.007560909725725653, -0.007560909725725653, -4.182153701782227, 1465.2679435653918, 2694.4216057066988)"
                  />
                </svg>
                Archidekt
              </button>
    ...
    {#if hasDeck}
      <div class="flex items-center gap-3">
        ...
        <div
          ...
          bind:this={branchDropdownRef}
        >
          <span class="text-sm text-[var(--color-text-secondary)] font-semibold"
            >Branch:</span
          >
          <button
          ...
          {#if branchDropdownOpen && availableBranches.length > 0}
            ...
            >
              {#each availableBranches as branch}
                <div
                  class="flex items-center hover:bg-[var(--color-surface-hover)]"
                >
                  <button
                    onclick={() => {
                    ...
                    class="flex-1 px-4 py-2 text-left text-sm {branch ===
                    currentBranch
