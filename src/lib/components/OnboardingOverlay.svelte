...
{#if isOpen}
	...
	>
		<!-- Onboarding Card -->
		<div
			class="bg-[var(--color-surface)] rounded-lg shadow-2xl max-w-lg w-full max-h-[90vh] flex flex-col border border-[var(--color-border)]"
			role="dialog"
			aria-modal="true"
			tabindex="-1"
		>
			...
			<div class="px-4 py-4 overflow-y-auto flex-1">
				<!-- Icon -->
				<div class="flex justify-center mb-4 text-[var(--color-brand-primary)]">
					{@html steps[currentStep].icon}
				</div>

				<!-- Content -->
				<div class="prose prose-invert max-w-none">
					<div class="text-[var(--color-text-primary)] space-y-3 text-sm leading-relaxed">
